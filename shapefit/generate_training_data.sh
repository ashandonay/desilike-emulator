...
#   --             everything after is passed through to the generator
#
# Examples:
#   shapefit/generate_training_data.sh --cosmo-model base --n-samples 64 --workers 8 --version 99
#   shapefit/generate_training_data.sh --quantity mean --n-samples 10000
set -euo pipefail

# --- env (emulator conda env; cwd must be the shapefit/ dir) ----------------
